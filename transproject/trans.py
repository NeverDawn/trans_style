...
styleImg = Image.open("./styles/style2.png")
contentImg = Image.open("./contents/content2.png")
x=contentImg.size[0]
y=contentImg.size[1]
...
loader = transforms.Compose([
    transforms.Resize(min(x,y)),  # scale imported image
    transforms.ToTensor()])  # transform it into a torch tensor
...
image.save('./outputs/output2-2.png')
